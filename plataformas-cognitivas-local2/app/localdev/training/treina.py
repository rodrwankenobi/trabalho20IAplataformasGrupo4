...
if __name__ == "__main__":
    # Carrega os dados
    mydf = pd.concat([
        pd.read_csv('/app/datasets/BaseDefault01.csv'),
        pd.read_csv('/app/datasets/BaseDefault02.csv')
        ])
    ...
    joblib.dump(clf, '/app/localdev/models/modelo01.joblib')
    print("Modelo 01 (classificador) salvo com sucesso.")
    joblib.dump(rgs, '/app/localdev/models/modelo02.joblib')
